    ...
    <React.Fragment>
        ...
        <Row justify="center">
          <Col style={{ width: "90vw" }} lg={20} sm={22} md={22} xs={22}>
            <Row justify="space-around">
              <h1 className="feedback-head">Why do agents love this app?</h1>
            </Row>
          </Col>
        </Row>
        <Row justify={"space-around"}>
          <Col lg={20} sm={22} md={22} xs={22}>
            <Row gutter={24} justify="center">
              <Col lg={8} md={24} sm={24} xs={24}>
                ...
                <Row className="feedback-author">Mr.Virat Kohli</Row>
      ...
      <Row justify="center">
        <Col style={{ width: "90vw" }} lg={17} sm={23} md={23} xs={23}>
          <h1 className="well">
            Are you a bus booking agent? Get your account today -{" "}
        ...
        <Row justify="center">
          <Col span={20}>
            ...
            <Row>
              <ul>
                <li className="li">
                  Bus operator has to approve you to be an agent for their buses
                </li>
                <li className="li">
                  Seat cancellation is allowed through bus operator
                </li>
              </ul>
            </Row>
          </Col>
